    ...
    <div class="flip-card">
        <div class="flip-card-inner">
            ...
            <div class="flip-card-back">
                <h3>Registrate como estudiante para realizar tu test  de nivel  de ansiedad</h3>
    ...
    <div class="popup" id="popup" name="popup">
        ...
        <div class="contenedor">
            ...
            <div class=texto-encima>
                ...
                <form method="POST" action="<//?php echo $_SERVER['PHP_SELF']; ?>" name="iniciar_sesion" id="iniciar_sesion"> 
