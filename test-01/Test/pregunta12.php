...
<h4>12.- Con temblores en las manos.</h4>
<input type="radio" name="Pregunta12" value="0">No
<input type="radio" name="Pregunta12" value="1">Leve
<input type="radio" name="Pregunta12" value="2">Moderado
<input type="radio" name="Pregunta12" value="3">Bastante
