...
<h4>15.- Con sensación de ahogo.</h4>
<input type="radio" name="Pregunta15" value="0">No
<input type="radio" name="Pregunta15" value="1">Leve
<input type="radio" name="Pregunta15" value="2">Moderado
<input type="radio" name="Pregunta15" value="3">Bastante
