...
<h4>11.- Con sensación de bloqueo.</h4>
<input type="radio" name="Pregunta11" value="0">No
<input type="radio" name="Pregunta11" value="1">Leve
<input type="radio" name="Pregunta11" value="2">Moderado
<input type="radio" name="Pregunta11" value="3">Bastante
