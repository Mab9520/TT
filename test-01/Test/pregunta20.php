...
<h4>20.- Con rubor facial.</h4>
<input type="radio" name="Pregunta20" value="0">No
<input type="radio" name="Pregunta20" value="1">Leve
<input type="radio" name="Pregunta20" value="2">Moderado
<input type="radio" name="Pregunta20" value="3">Bastante
