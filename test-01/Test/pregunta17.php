...
<h4>17.- Con miedo.</h4>
<input type="radio" name="Pregunta17" value="0">No
<input type="radio" name="Pregunta17" value="1">Leve
<input type="radio" name="Pregunta17" value="2">Moderado
<input type="radio" name="Pregunta17" value="3">Bastante
