                ...
                <form action="pregunta14.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 respuesta">
                            <input type="radio" name="Pregunta13" value="0">No
                        </div>
                        <div class="col-12 col-lg-6 respuesta">
                            <input type="radio" name="Pregunta13" value="1">Leve 
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-6 respuesta">
                            <input type="radio" name="Pregunta13" value="2">Moderado
                        </div>
                        <div class="col-12 col-lg-6 respuesta">
                            <input type="radio" name="Pregunta13" value="3">Bastante
                        </div>
                    </div>
                    <div class="col-12">
