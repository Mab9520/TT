...
<h4>19.- Con desvanecimientos.</h4>
<input type="radio" name="Pregunta19" value="0">No
<input type="radio" name="Pregunta19" value="1">Leve
<input type="radio" name="Pregunta19" value="2">Moderado
<input type="radio" name="Pregunta19" value="3">Bastante
